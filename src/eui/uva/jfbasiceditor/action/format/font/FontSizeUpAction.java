...
public class FontSizeUpAction extends Action {
	...
	public FontSizeUpAction(JFaceBasicEditor w){
		...
		try
		{
			...
			setText("   &Aumentar tamaño@Ctrl+R");
			setToolTipText("Aumenta el tamaño de la fuente");
			setDescription("Aumenta el tamaño de la fuente");
			editor.setStatus("Pulse para aumentar el tamaño de la fuente");
